...
{
    public class HitWaypointCommandExecutor : BaseCommandExecutor<HitWaypointCommand, ResultWithError<ErrorData>>
    {
        private readonly ICurrentUserAccessor _currentUserAccessor;
        private readonly CloudTable _trekTable;
        private readonly CloudTable _waypointTable;

        public HitWaypointCommandExecutor(
            IValidator<HitWaypointCommand> validator,
        ...
        protected override async Task<ResultWithError<ErrorData>> Executor()
        {
            ...
            var updateResult = await this._waypointTable.UpdateEntity(waypoint);
