...
{
    public class UpdateTrekImageCommandValidator : AbstractValidator<UpdateTrekImageCommand>
    {
        public UpdateTrekImageCommandValidator()
        {
            this.RuleFor(x => x.ImageUri).NotEmpty().WithErrorCode(ValidationCodes.FieldIsRequired);
