...
{
    public static class CreateUpdateCommandEndpoint
    {
            ...
            ExecutionContext context)
        {
            try
            {
                ...
                var executor = new CreateUpdateCommandExecutor(validator, trekTable, currentUserAccessor, updateTable);

                var cmd = await req.GetCommand<CreateUpdateCommand>();
