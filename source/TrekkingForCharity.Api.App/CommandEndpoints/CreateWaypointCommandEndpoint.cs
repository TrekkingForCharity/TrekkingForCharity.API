...
{
    public static class CreateWaypointCommandEndpoint
    {
            ...
            ExecutionContext context)
        {
            try
            {
                ...
                var cmd = await req.GetCommand<CreateWaypointCommand>();

                var executor =
                    new CreateWaypointCommandExecutor(validator, trekTable, currentUserAccessor, waypointTable);
