...
{
    public static class StartTrekCommandExecutor
    {
        [FunctionName("StartTrekCommandExecutor")]
        public static async Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Admin, "post", Route = "commands/start-trek")] HttpRequest req,
            ...
            ExecutionContext context)
        {
            try
            {
                ...
                var cmd = JsonConvert.DeserializeObject<StartTrekCommand>(jsonContent);
