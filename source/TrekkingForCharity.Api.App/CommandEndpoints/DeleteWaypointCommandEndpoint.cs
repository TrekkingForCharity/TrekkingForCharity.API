...
{
    public static class DeleteWaypointCommandEndpoint
    {
        [FunctionName("DeleteWaypointCommandEndpoint")]
            ...
            ExecutionContext context)
        {
            try
            {
                ...
                var executor =
                    new DeleteWaypointCommandExecutor(validator, currentUserAccessor, trekTable, waypointTable);

                var cmd = await req.GetCommand<DeleteWaypointCommand>();
