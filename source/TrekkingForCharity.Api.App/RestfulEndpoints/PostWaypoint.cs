...
{
    public static class PostWaypoint
    {
        [FunctionName("PostWaypoint")]
        public static async Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "treks/{trekId}/waypoints")]
            ...
            TraceWriter log)
        {
            try
            {
                ...
                var update = new Waypoint(cmd.Lng, cmd.Lat, cmd.WhenToHit, Guid.Parse(trekId));
