...
namespace TrekkingForCharity.Api.App.RestfulEndpoints
{
    public static class PostUpdate
    {
        ...
        public static async Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Admin, "post", Route = "treks/{trekId}/updates")] HttpRequest req,
            ...
            ExecutionContext context)
        {
            try
            {
                ...
                return HttpRequestMessageHelpers.CreateSuccessResponseMessage(update.ToRead());
            }
            catch (Exception ex)
            {
